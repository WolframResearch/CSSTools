...
(*])&, *)
(*{*)
(*	Table[With[{t = hslColorTests[[i, 1]]}, Defer[List@@ColorConvert[CSSTools`CSSPropertyInterpreter`parseSingleColor["color",First[CSSTools`CSSTokenizer`CSSTokenize@ t]], "RGB"]]], {i, Length[hslColorTests]}], *)
(*	N /@ hslColorTests[[All, 2]]}]*)
