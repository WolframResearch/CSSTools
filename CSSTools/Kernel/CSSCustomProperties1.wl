...
DownValues[consumeProperty] = DeleteDuplicates @ (* in case this file is loaded multiple times, delete duplicate DownValues *)
	Join[
		{
			(* corner case of no property value is still a valid custom property definition *)
			HoldPattern[
